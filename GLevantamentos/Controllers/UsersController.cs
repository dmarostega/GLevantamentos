...
namespace GLevantamentos.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(GLevantamentosContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Username,Password,Created_at,Updated_at")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
