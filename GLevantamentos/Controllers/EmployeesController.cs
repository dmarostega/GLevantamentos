...
namespace GLevantamentos.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(GLevantamentosContext context)
        {
            _context = context;
        }
        ...
        {
            var gLevantamentosContext = _context.Employee.Include(e => e.City).Include(e => e.User);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Address,UserId,CityId,Created_at,Updated_at")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
